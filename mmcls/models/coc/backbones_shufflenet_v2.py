...
from mmcv.cnn import constant_init, normal_init  # ConvModule  # TODO XXX
...
class ShuffleNetV2Coc(nn.Module):
    ...
    def __init__(self,
            ...
            norm_eval=False,
            with_cp=False):
        super(ShuffleNetV2Coc, self).__init__()
    ...
    def train(self, mode=True):
        super(ShuffleNetV2Coc, self).train(mode)
        self._freeze_stages()
